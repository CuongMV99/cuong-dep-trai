<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dNewsDetail.ascx.cs" Inherits="WebBanHoa.display.News.dNewsDetail" %>
                ...
                <div class="col-lg-12">
                    <div class="blog-details-inner">
                        <div class="blog-detail-title">
                            ...
                            <p><asp:Literal ID="ltNewsCategory" runat="server"></asp:Literal><span>- <asp:Literal ID="ltDate" runat="server"></asp:Literal></span></p>
                        </div>
                        <div class="blog-large-pic">
                            <asp:Image ID="imgNewsDetail" runat="server"/>
                        </div>
